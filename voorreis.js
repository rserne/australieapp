...
{datum:"2026-09-20",k:"vlucht",t:"Naar Cairns en het rif",p:"Cairns",tz:10,temp:"20–29°",
 ...
 body:[
  "Van winter naar de tropen in drie uur, want in Cairns is het rond de dertig graden en vochtig. Je landt om 10.02 uur en om 12.30 uur vaar je al uit naar het grootste koraalrif ter wereld.",
 ...
 wild:[["Groene zeeschildpad","Bij het buitenrif zwemmen ze rustig langs de koraalranden. Bijna elke snorkelaar ziet er minstens een.",3],
  ["Anemoonvis en reuzendoopvont","Clownvissen in hun anemoon en reuzenschelpen van een meter breed, allebei op ondiepe plekken bij het platform.",3],
...
{datum:"2026-09-21",k:"excursie",t:"Atherton Tablelands",p:"Atherton Tablelands",tz:10,temp:"15–27°, 's avonds koel",
 ...
 body:[
  ...
  "Het mooiste komt na zonsondergang. De Tablelands zijn een van de beste plekken van Australië om in het donker dieren te zien, met de vogelbekdier-kijkplek bij Yungaburra als hoogtepunt. Neem iets warms mee, want het scheelt hier 's avonds zomaar tien graden met Cairns."
 ],
...
{datum:"2026-09-22",k:"vlucht",t:"Naar Arnhemland",p:"Cairns → Nhulunbuy",tz:9.5,temp:"21–30°",
 ...
 prac:["Voor Nhulunbuy zelf heb je geen vergunning nodig, maar zodra je het stadje verlaat wel. Voor de stranden, Yirrkala en de baaien heb je een toegangsvergunning van Dhimurru of de Northern Land Council nodig. Reist je excursie erheen, dan regelt de organisatie dat. Ga er zelf niet zonder op uit, want dan sta je op privéland.",
...
{datum:"2026-09-23",k:"excursie",t:"Yolŋu-kunst in Yirrkala",p:"Yirrkala",tz:9.5,temp:"21–30°",
 ...
 body:[
  ...
  "In het museum achter de galerie hangen de kerkpanelen uit 1962, waarop kunstenaars van beide moieties hun ontwerpen naast elkaar zetten. Een jaar later gingen vanuit dit dorp de bark petitions naar het parlement in Canberra, een petitie tegen de mijnbouw die op boombast was geschilderd. Het werd het begin van de Australische landrechtenbeweging. Zonder Yirrkala geen Mabo-arrest."
 ],
...
{datum:"2026-09-24",k:"vlucht",t:"Dreamtime hike en door naar Darwin",p:"Nhulunbuy → Darwin",tz:9.5,temp:"24–33°",
 ...
 agenda:[["08.00","Dreamtime hike","Wandeling met een Yolŋu-gids door het land rond het schiereiland."],
  ...
  ["Vanaf 17.00","Mindil Beach Sunset Market","Donderdagavond, 16.00 tot 21.00 uur. Twintig minuten van het centrum."]],
 body:[
